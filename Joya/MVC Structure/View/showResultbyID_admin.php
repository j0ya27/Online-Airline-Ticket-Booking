...
<?php include "UI.php";?>
  ...
  <body> 
	...
	<section id="header">
		<div class="row">  
			<div class="col-md-10" style="text-align: center; font-size: 100px; color:#2d2244"> Joya Airpath </div>
			<div class="col-md-10" style="text-align: center;font-size: 25px; color:#2d2244"> 
				...
				<a href='../Controller/search_admin.php' style="margin-left: 20px;"> Search Flight </a> <br><br><br>
...
if(isset($_POST['fid'])){
	...
	$sql = "SELECT fid,fdate,fpl,fst,del,des,dep FROM flight_details WHERE  fid = '$b' ";  
